...
export default function About() {
  ...
  return (
    <div className="min-h-screen py-8 sm:py-12 bg-bg-base text-text-primary">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 sm:space-y-12">
        {/* Header Banner */}
        <div className="text-center space-y-3 sm:space-y-4 max-w-3xl mx-auto">
          <h1 className="font-serif font-bold text-2xl sm:text-4xl lg:text-5xl text-text-primary leading-tight">
        ...
        <div className="space-y-4">
          <h2 className="font-serif font-bold text-xl sm:text-2xl text-text-primary text-center sm:text-left">
            Alur Kerja Projek & Arsitektur Rekomendasi
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="bg-white p-4 sm:p-5 rounded-2xl border border-border shadow-soft space-y-2">
              <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-slate-900 text-amber-400 font-serif font-bold flex items-center justify-center text-sm sm:text-base">
                1
              </div>
              <h3 className="font-serif font-bold text-xs sm:text-sm text-text-primary">Query Input & Spellcheck</h3>
            ...
            <div className="bg-white p-4 sm:p-5 rounded-2xl border border-border shadow-soft space-y-2">
              ...
              <h3 className="font-serif font-bold text-xs sm:text-sm text-text-primary">Multilingual Vector Embeddings</h3>
              <p className="text-xs text-text-secondary leading-relaxed">
            ...
            <div className="bg-white p-4 sm:p-5 rounded-2xl border border-border shadow-soft space-y-2">
              ...
              <h3 className="font-serif font-bold text-xs sm:text-sm text-text-primary">Cosine Similarity Retrieval</h3>
              <p className="text-xs text-text-secondary leading-relaxed">
            ...
            <div className="bg-white p-4 sm:p-5 rounded-2xl border border-border shadow-soft space-y-2">
              ...
              <h3 className="font-serif font-bold text-xs sm:text-sm text-text-primary">Cross-Encoder Reranking (Opsional)</h3>
              <p className="text-xs text-text-secondary leading-relaxed">
        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl border border-border p-4 sm:p-8 shadow-soft space-y-6 sm:space-y-8">
          <div className="flex items-center gap-3 border-b border-border/80 pb-4">
            <Award className="w-6 h-6 sm:w-7 sm:h-7 text-amber-600 shrink-0" />
            <div>
              <h2 className="font-serif font-bold text-lg sm:text-2xl text-text-primary">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-2 sm:gap-3">
            <div className="p-3 sm:p-3.5 rounded-xl sm:rounded-2xl bg-amber-50/60 border border-amber-200/80 text-center">
              <span className="text-[9px] sm:text-[10px] font-bold text-amber-800 uppercase block mb-0.5">MAP@5</span>
              <span className="text-lg sm:text-xl font-bold font-serif text-amber-700">{mpnetRetrieval.map_at_5.toFixed(4)}</span>
              <span className="text-[9px] text-text-muted block mt-0.5">Mean Avg Precision</span>
            </div>

            <div className="p-3 sm:p-3.5 rounded-xl sm:rounded-2xl bg-amber-50/60 border border-amber-200/80 text-center">
              <span className="text-[9px] sm:text-[10px] font-bold text-amber-800 uppercase block mb-0.5">MAP@10</span>
              <span className="text-lg sm:text-xl font-bold font-serif text-amber-700">{mpnetRetrieval.map_at_10.toFixed(4)}</span>
              <span className="text-[9px] text-text-muted block mt-0.5">Mean Avg Precision</span>
            </div>

            <div className="p-3 sm:p-3.5 rounded-xl sm:rounded-2xl bg-slate-50 border border-slate-200 text-center">
              <span className="text-[9px] sm:text-[10px] font-bold text-slate-700 uppercase block mb-0.5">Precision@5</span>
              <span className="text-lg sm:text-xl font-bold font-serif text-slate-900">{mpnetRetrieval.precision_at_5.toFixed(4)}</span>
              <span className="text-[9px] text-text-muted block mt-0.5">Rasio Presisi Top-5</span>
            </div>

            <div className="p-3 sm:p-3.5 rounded-xl sm:rounded-2xl bg-slate-50 border border-slate-200 text-center">
              <span className="text-[9px] sm:text-[10px] font-bold text-slate-700 uppercase block mb-0.5">MRR@10</span>
              <span className="text-lg sm:text-xl font-bold font-serif text-slate-900">{mpnetRetrieval.mrr_at_10.toFixed(4)}</span>
              <span className="text-[9px] text-text-muted block mt-0.5">Reciprocal Rank</span>
            </div>

            <div className="p-3 sm:p-3.5 rounded-xl sm:rounded-2xl bg-slate-50 border border-slate-200 text-center">
              <span className="text-[9px] sm:text-[10px] font-bold text-slate-700 uppercase block mb-0.5">NDCG@10</span>
              <span className="text-lg sm:text-xl font-bold font-serif text-slate-900">{mpnetRetrieval.ndcg_at_10.toFixed(4)}</span>
              <span className="text-[9px] text-text-muted block mt-0.5">Position Gain</span>
            </div>

            <div className="p-3 sm:p-3.5 rounded-xl sm:rounded-2xl bg-slate-50 border border-slate-200 text-center">
              <span className="text-[9px] sm:text-[10px] font-bold text-slate-700 uppercase block mb-0.5">Recall@10</span>
              <span className="text-lg sm:text-xl font-bold font-serif text-slate-900">{mpnetRetrieval.recall_at_10.toFixed(4)}</span>
          ...
          <div className="space-y-4 pt-2">
            <h3 className="font-serif font-bold text-sm sm:text-base text-text-primary flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
              {/* MAP Interpretation */}
              <div className="p-3.5 sm:p-4 rounded-2xl bg-amber-50/40 border border-amber-200/80 space-y-1.5">
                <span className="font-bold text-amber-900 text-xs sm:text-sm block">1. MAP (Mean Average Precision)</span>
              ...
              <div className="p-3.5 sm:p-4 rounded-2xl bg-slate-50 border border-slate-200 space-y-1.5">
                <span className="font-bold text-slate-900 text-xs sm:text-sm block">2. MRR (Mean Reciprocal Rank)</span>
                <p className="text-text-secondary leading-relaxed">
              ...
              <div className="p-3.5 sm:p-4 rounded-2xl bg-slate-50 border border-slate-200 space-y-1.5">
                <span className="font-bold text-slate-900 text-xs sm:text-sm block">3. Precision@K & Recall@K</span>
                <p className="text-text-secondary leading-relaxed">
              ...
              <div className="p-3.5 sm:p-4 rounded-2xl bg-slate-50 border border-slate-200 space-y-1.5">
                <span className="font-bold text-slate-900 text-xs sm:text-sm block">4. NDCG@K & Pooled Recall@50</span>
                <p className="text-text-secondary leading-relaxed">
          ...
          {safeMetricsList.length > 0 && (
            <div className="pt-4 border-t border-border/80">
              <h3 className="font-serif font-bold text-sm sm:text-base text-text-primary mb-3">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="flex items-start gap-3 p-4 rounded-2xl bg-white border border-border">
              ...
              <div>
                <h4 className="font-bold text-xs sm:text-sm text-text-primary">Cross-lingual support (34 Bahasa)</h4>
            ...
            <div className="flex items-start gap-3 p-4 rounded-2xl bg-white border border-border">
              ...
              <div>
                <h4 className="font-bold text-xs sm:text-sm text-text-primary">Multilingual Semantic Search & Reranking</h4>
                <p className="text-xs text-text-secondary mt-0.5">
